package com.example.igor.classmatesnew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                map.put("Name",c.getString(idColIndex) +". " + c.getString(nameColIndex) + " " + c.getString(name1ColIndex) + " " + c.getString(name2ColIndex));
